...
var (
	filter_RatingAndReviewService_GetNewestRatingListReview_0 = &utilities.DoubleArray{Encoding: map[string]int{"tour_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_RatingAndReviewService_GetNewestRatingListReview_0(ctx context.Context, marshaler runtime.Marshaler, client RatingAndReviewServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RatingReview
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetNewestRatingListReview(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RatingAndReviewService_GetNewestRatingListReview_0(ctx context.Context, marshaler runtime.Marshaler, server RatingAndReviewServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RatingReview
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetNewestRatingListReview(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_RatingAndReviewService_GetRatingListReview_0 = &utilities.DoubleArray{Encoding: map[string]int{"tour_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_RatingAndReviewService_GetRatingListReview_0(ctx context.Context, marshaler runtime.Marshaler, client RatingAndReviewServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestParams
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetRatingListReview(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_RatingAndReviewService_GetRatingListReview_0(ctx context.Context, marshaler runtime.Marshaler, server RatingAndReviewServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestParams
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetRatingListReview(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterRatingAndReviewServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RatingAndReviewServiceServer) error {
	...
	mux.Handle("GET", pattern_RatingAndReviewService_GetNewestRatingListReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_RatingAndReviewService_GetNewestRatingListReview_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_RatingAndReviewService_GetRatingListReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_RatingAndReviewService_GetRatingListReview_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterRatingAndReviewServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RatingAndReviewServiceClient) error {
	...
	mux.Handle("GET", pattern_RatingAndReviewService_GetNewestRatingListReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RatingAndReviewService_GetNewestRatingListReview_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_RatingAndReviewService_GetRatingListReview_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_RatingAndReviewService_GetRatingListReview_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_RatingAndReviewService_GetRatingListReview_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v1", "reviews", "tourpackages", "tour_id", "list"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_RatingAndReviewService_GetNewestRatingListReview_0 = runtime.ForwardResponseMessage

	forward_RatingAndReviewService_GetRatingListReview_0 = runtime.ForwardResponseMessage
)
