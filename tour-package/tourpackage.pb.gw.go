...
var (
	filter_TourPackageExplorerService_Browse_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_TourPackageExplorerService_Browse_0(ctx context.Context, marshaler runtime.Marshaler, client TourPackageExplorerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InitExplorerRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TourPackageExplorerService_Browse_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.Browse(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TourPackageExplorerService_Browse_0(ctx context.Context, marshaler runtime.Marshaler, server TourPackageExplorerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq InitExplorerRequest
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_TourPackageExplorerService_Browse_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := server.Browse(ctx, &protoReq)
	return msg, metadata, err
...
// RegisterTourPackageExplorerServiceHandlerServer registers the http handlers for service TourPackageExplorerService to "mux".
// UnaryRPC     :call TourPackageExplorerServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
func RegisterTourPackageExplorerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TourPackageExplorerServiceServer) error {

	mux.Handle("GET", pattern_TourPackageExplorerService_Browse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_TourPackageExplorerService_Browse_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_TourPackageExplorerService_Browse_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterTourPackageExplorerServiceHandlerFromEndpoint is same as RegisterTourPackageExplorerServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterTourPackageExplorerServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterTourPackageExplorerServiceHandler(ctx, mux, conn)
}

// RegisterTourPackageExplorerServiceHandler registers the http handlers for service TourPackageExplorerService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterTourPackageExplorerServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterTourPackageExplorerServiceHandlerClient(ctx, mux, NewTourPackageExplorerServiceClient(conn))
}

// RegisterTourPackageExplorerServiceHandlerClient registers the http handlers for service TourPackageExplorerService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "TourPackageExplorerServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "TourPackageExplorerServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "TourPackageExplorerServiceClient" to call the correct interceptors.
func RegisterTourPackageExplorerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TourPackageExplorerServiceClient) error {
	...
	mux.Handle("GET", pattern_TourPackageExplorerService_Browse_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TourPackageExplorerService_Browse_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_TourPackageExplorerService_Browse_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "package-explorers"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_TourPackageExplorerService_Browse_0 = runtime.ForwardResponseMessage
)
...
var (
	pattern_TourPackageService_CreateTourPackage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "tourhosts", "host_id", "tourpackages"}, "", runtime.AssumeColonVerbOpt(true)))
	...
	pattern_TourPackageService_UpdateTourPackage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 2}, []string{"api", "v1", "tourpackages", "tour_id"}, "", runtime.AssumeColonVerbOpt(true)))
