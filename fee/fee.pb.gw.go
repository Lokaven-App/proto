...
var (
	filter_FeeService_GetFeeByFeeName_0 = &utilities.DoubleArray{Encoding: map[string]int{"fee_name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_FeeService_GetFeeByFeeName_0(ctx context.Context, marshaler runtime.Marshaler, client FeeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Fee
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FeeService_GetFeeByFeeName_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetFeeByFeeName(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_FeeService_GetFeeByFeeName_0(ctx context.Context, marshaler runtime.Marshaler, server FeeServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Fee
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetFeeByFeeName(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterFeeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FeeServiceServer) error {
	...
	mux.Handle("GET", pattern_FeeService_GetFeeByFeeName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_FeeService_GetFeeByFeeName_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_FeeService_GetFeeByFeeName_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFeeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FeeServiceClient) error {
	...
	mux.Handle("GET", pattern_FeeService_GetFeeByFeeName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_FeeService_GetFeeByFeeName_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_FeeService_GetFeeByFeeName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v1", "fees", "fee-name", "fee_name", "users"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_FeeService_GetFeeByFeeName_0 = runtime.ForwardResponseMessage
)
