...
var file_tax_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xae, 0x06, 0x0a,
	...
	0x73, 0x12, 0x75, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x78, 0x42, 0x79, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0f, 0x2e,
	0x74, 0x61, 0x78, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x54, 0x61, 0x78, 0x1a, 0x1f,
	0x2e, 0x74, 0x61, 0x78, 0x2e, 0x54, 0x61, 0x78, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	...
	,
...
var file_tax_proto_depIdxs = []int32{
	...
	5,  // 20: tax.TaxService.ListTaxByTransactionList:input_type -> tax.RequestTax
	1,  // 21: tax.TaxService.DetailTaxByTransactionList:input_type -> tax.TaxTransaction
	7,  // 22: tax.TaxService.AddTax:output_type -> tax.TaxResponse
	7,  // 23: tax.TaxService.EditTax:output_type -> tax.TaxResponse
	8,  // 24: tax.TaxService.DeleteTax:output_type -> tax.TaxDeleteResponse
	7,  // 25: tax.TaxService.DetailTax:output_type -> tax.TaxResponse
	9,  // 26: tax.TaxService.ListTax:output_type -> tax.TaxListResponse
	11, // 27: tax.TaxService.LokavenTaxReport:output_type -> tax.ResponseLokavenTax
	2,  // 28: tax.TaxService.ListTaxByTransactionList:output_type -> tax.TaxTransactionListResponse
	3,  // 29: tax.TaxService.DetailTaxByTransactionList:output_type -> tax.TaxTransactionResponse
...
type TaxServiceClient interface {
	...
	ListTaxByTransactionList(ctx context.Context, in *RequestTax, opts ...grpc.CallOption) (*TaxTransactionListResponse, error)
	DetailTaxByTransactionList(ctx context.Context, in *TaxTransaction, opts ...grpc.CallOption) (*TaxTransactionResponse, error)
}
...
func (c *taxServiceClient) ListTaxByTransactionList(ctx context.Context, in *RequestTax, opts ...grpc.CallOption) (*TaxTransactionListResponse, error) {
	out := new(TaxTransactionListResponse)
	err := c.cc.Invoke(ctx, "/tax.TaxService/ListTaxByTransactionList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taxServiceClient) DetailTaxByTransactionList(ctx context.Context, in *TaxTransaction, opts ...grpc.CallOption) (*TaxTransactionResponse, error) {
	out := new(TaxTransactionResponse)
	err := c.cc.Invoke(ctx, "/tax.TaxService/DetailTaxByTransactionList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaxServiceServer interface {
	...
	ListTaxByTransactionList(context.Context, *RequestTax) (*TaxTransactionListResponse, error)
	DetailTaxByTransactionList(context.Context, *TaxTransaction) (*TaxTransactionResponse, error)
}
...
func (*UnimplementedTaxServiceServer) ListTaxByTransactionList(context.Context, *RequestTax) (*TaxTransactionListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTaxByTransactionList not implemented")
}
func (*UnimplementedTaxServiceServer) DetailTaxByTransactionList(context.Context, *TaxTransaction) (*TaxTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DetailTaxByTransactionList not implemented")
}
...
func _TaxService_ListTaxByTransactionList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestTax)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaxServiceServer).ListTaxByTransactionList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tax.TaxService/ListTaxByTransactionList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaxServiceServer).ListTaxByTransactionList(ctx, req.(*RequestTax))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaxService_DetailTaxByTransactionList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaxTransaction)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaxServiceServer).DetailTaxByTransactionList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tax.TaxService/DetailTaxByTransactionList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaxServiceServer).DetailTaxByTransactionList(ctx, req.(*TaxTransaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TaxService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListTaxByTransactionList",
			Handler:    _TaxService_ListTaxByTransactionList_Handler,
		},
		{
			MethodName: "DetailTaxByTransactionList",
			Handler:    _TaxService_DetailTaxByTransactionList_Handler,
		},
	},
