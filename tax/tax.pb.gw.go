...
var (
	filter_TaxService_ListTaxByTransactionList_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_TaxService_ListTaxByTransactionList_0(ctx context.Context, marshaler runtime.Marshaler, client TaxServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestTax
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TaxService_ListTaxByTransactionList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListTaxByTransactionList(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TaxService_ListTaxByTransactionList_0(ctx context.Context, marshaler runtime.Marshaler, server TaxServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestTax
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListTaxByTransactionList(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_TaxService_DetailTaxByTransactionList_0 = &utilities.DoubleArray{Encoding: map[string]int{"log_tax_transactions_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_TaxService_DetailTaxByTransactionList_0(ctx context.Context, marshaler runtime.Marshaler, client TaxServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TaxService_DetailTaxByTransactionList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.DetailTaxByTransactionList(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_TaxService_DetailTaxByTransactionList_0(ctx context.Context, marshaler runtime.Marshaler, server TaxServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TaxTransaction
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DetailTaxByTransactionList(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTaxServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TaxServiceServer) error {
	...
	mux.Handle("GET", pattern_TaxService_ListTaxByTransactionList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_TaxService_ListTaxByTransactionList_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_TaxService_ListTaxByTransactionList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_TaxService_DetailTaxByTransactionList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_TaxService_DetailTaxByTransactionList_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_TaxService_DetailTaxByTransactionList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTaxServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TaxServiceClient) error {
	...
	mux.Handle("GET", pattern_TaxService_ListTaxByTransactionList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TaxService_ListTaxByTransactionList_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_TaxService_DetailTaxByTransactionList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TaxService_DetailTaxByTransactionList_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TaxService_ListTaxByTransactionList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "v1", "taxes", "transaction", "lists"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_TaxService_DetailTaxByTransactionList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"api", "v1", "taxes", "transaction", "detail", "log_tax_transactions_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_TaxService_ListTaxByTransactionList_0 = runtime.ForwardResponseMessage

	forward_TaxService_DetailTaxByTransactionList_0 = runtime.ForwardResponseMessage
)
