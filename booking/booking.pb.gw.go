...
func request_BookingRPC_DetailBookingByHost_0(ctx context.Context, marshaler runtime.Marshaler, client BookingRPCClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DetailBookingHost
	var metadata runtime.ServerMetadata
...
// Note that using this registration option will cause many gRPC library features (such as grpc.SendHeader, etc) to stop working. Consider using RegisterBookingRPCHandlerFromEndpoint instead.
