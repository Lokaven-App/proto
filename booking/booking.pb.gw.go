...
var (
	filter_BookingRPC_ListBooking_0 = &utilities.DoubleArray{Encoding: map[string]int{"param": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	...
	pattern_BookingRPC_ListBooking_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"api", "v1", "orders", "list", "param"}, "", runtime.AssumeColonVerbOpt(true)))
