...
func request_BookingRPC_ConfirmEndTourByGuest_0(ctx context.Context, marshaler runtime.Marshaler, client BookingRPCClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestEndedScheduleByGuest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ConfirmEndTourByGuest(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_BookingRPC_ConfirmEndTourByGuest_0(ctx context.Context, marshaler runtime.Marshaler, server BookingRPCServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RequestEndedScheduleByGuest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ConfirmEndTourByGuest(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBookingRPCHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BookingRPCServer) error {
	...
	mux.Handle("PATCH", pattern_BookingRPC_ConfirmEndTourByGuest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_BookingRPC_ConfirmEndTourByGuest_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_BookingRPC_ConfirmEndTourByGuest_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBookingRPCHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BookingRPCClient) error {
	...
	mux.Handle("PATCH", pattern_BookingRPC_ConfirmEndTourByGuest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BookingRPC_ConfirmEndTourByGuest_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_BookingRPC_ConfirmEndTourByGuest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"api", "v1", "orders", "tourpackages", "tour_id", "schedules", "schedule_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_BookingRPC_ConfirmEndTourByGuest_0 = runtime.ForwardResponseMessage
)
